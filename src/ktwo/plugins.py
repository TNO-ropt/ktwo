...
from ropt.config.plan import ResultHandlerConfig, StepConfig  # noqa: TCH002
from ropt.plan import Plan  # noqa: TCH002
...
class K2PlanPlugin(PlanPlugin):
    ...
    def create(  # type: ignore[override]
        self,
        config: Union[ResultHandlerConfig, StepConfig],
        plan: Plan,
